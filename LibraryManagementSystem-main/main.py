...
# Modified appearance and colors
lf_bg = 'grey'         # Left Frame Background Color
rtf_bg = 'red'          # Right Top Frame Background Color
rbf_bg = 'white'        # Right Bottom Frame Background Color
entry_bg = 'gray'       # Background color for Entry widgets
btn_hlb_bg = 'red'      # Background color for Head Labels and Buttons


lbl_font = ('Arial', 12, 'bold')   # Font for all labels
entry_font = ('Arial', 12)        # Font for all Entry widgets
btn_font = ('Arial', 12, 'bold')  # Font for buttons
